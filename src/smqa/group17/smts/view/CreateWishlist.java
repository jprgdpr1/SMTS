...
public class CreateWishlist {
	...
	public CreateWishlist(String username, Scanner scanner) {
        ...
        System.out.print("Please type in Stock Symbol to add to your Wishlist: ");
        String stockSymbol = scanner.next();
        
        DashboardController.addStockToWishlist(stockSymbol, username);
        
        System.out.println(stockSymbol + " has been added to your Wishlist");
	}
