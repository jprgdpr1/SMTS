...
public class SellStock {
	...
	public SellStock(String username, Scanner scanner) {
        ...
        System.out.println();
        System.out.print("Enter the stock symbol you want to sell from your Portfolio: ");
        String stockToSell = scanner.next();
        System.out.print("Enter the number of shares you want to sell: ");
        int numberOfShares = scanner.nextInt();
        
        DashboardController.sellStock(username, stockToSell, numberOfShares);
	}
